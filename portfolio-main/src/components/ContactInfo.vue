...
const data = reactive([
    {
        ...
        title: 'Phone',
        value: '+62 83843755178',
        href: 'tel:+62 3843755178',
        target: null,
    },
    {
        ...
        title: 'Telegram',
        value: '@Gill_hyrss',
        href: 'https://t.me/Gill_hyrss',
        target: '_blank',
    },
    {
        icon: 'mdi-gmail',
        title: 'Gmail',
        value: 'gilanghadyr@gmail.com',
        href: 'mailto:gilanghadyr@gmail.com',
        target: null,
    },
    {
        icon: 'mdi-github',
        title: 'GitHub',
        value: 'GilangHyrs',
        href: 'https://github.com/GilangHrys',
        target: '_blank',
    },
