...
const profile = reactive({
    fullName: 'Gilang Hady Rasyid',
    position: 'Mahasiswa Teknik Infomatika S1 , UIR',
});
</script>
<template>
    <div class="container">
        <div class="profile">
            <div class="profile__image">
                <v-avatar :size="smAndDown ? 200 : 300">
                    <v-img src="gilang1.jpg" lazy-src="gilang1.jpg" alt="Profile avatar" title="Profile avatar"></v-img>
                </v-avatar>
            </div>
